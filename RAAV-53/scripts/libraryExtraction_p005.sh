...
#SBATCH -J LibraryExt
#SBATCH -o /home/hooimin/lu2024-17-19/RAAV-53/26_S3_L001_R1_001/04_library/lib.out
#SBATCH -e /home/hooimin/lu2024-17-19/RAAV-53/26_S3_L001_R1_001/04_library/lib.err
...
for dir in "${directories[@]}"; do
    for file in "$dir"/01_qualityTrim/*_subclean.fastq.gz; do
        ...
        python /home/hooimin/lu2024-17-19/RAAV-53/scripts/libraryExt_p005.py "$dir/04_library/$processed_name1" "$dir/04_library/${base_name1}_53_005.fastq.gz"
    done
done
