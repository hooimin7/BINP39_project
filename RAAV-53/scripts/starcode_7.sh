...
#SBATCH -J Starcode
#SBATCH -o /home/hooimin/lu2024-17-19/RAAV-53/26_S3_L001_R1_001/05_starcode/star_7.out
#SBATCH -e /home/hooimin/lu2024-17-19/RAAV-53/26_S3_L001_R1_001/05_starcode/star_7.err
#SBATCH -D /home/hooimin/lu2024-17-19/RAAV-53/26_S3_L001_R1_001/05_starcode
...
for dir in "${directories[@]}"; do
    for file in "$dir"/03_pairfq/barcodes_7_BarLib_paired_reads.fastq.gz; do
        # Input Files
        ...
        reads_BC="$dir/03_pairfq/barcodes_7_BarLib_paired_reads.fastq.gz"
        ...
        # Save the result
        echo "$table_BC_sc" > "$dir/05_starcode/01_data/scBC_DNA_pscAAVlib_7.txt"
