...
#SBATCH -J LibraryExt
#SBATCH -o /home/hooimin/lu2024-17-19/RAAV-72/S26_S1_L001_R1_001/04_library/lib.out
#SBATCH -e /home/hooimin/lu2024-17-19/RAAV-72/S26_S1_L001_R1_001/04_library/lib.err
#SBATCH -D /home/hooimin/lu2024-17-19/RAAV-72/S26_S1_L001_R1_001/04_library
...
for dir in "${directories[@]}"; do
    for file in "$dir"/01_qualityTrim/*_subclean.fastq.gz; do
        ...
        out_name_R1L=$(mktemp -p . "p005R1L_lib_XXXXXXXXXX.fastq.gz")
        ...
        in="$in_name_R1L" out="$out_name_R1L" lliteral="GTCTGAACTTGGGACT" 

        # Rename the output file
        mv "$out_name_R1L" "$dir/04_library/$processed_name1"

        # Run the Python script
        python /home/hooimin/lu2024-17-19/RAAV-72/scripts/libraryExt_p005.py "$dir/04_library/$processed_name1" "$dir/04_library/${base_name1}_72_005.fastq.gz"
    done
done
