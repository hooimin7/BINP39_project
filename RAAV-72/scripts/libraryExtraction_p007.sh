...
#SBATCH -J LibraryExt
#SBATCH -o /home/hooimin/lu2024-17-19/RAAV-72/S26_S1_L001_R1_001/04_library/lib_7.out
#SBATCH -e /home/hooimin/lu2024-17-19/RAAV-72/S26_S1_L001_R1_001/04_library/lib_7.err
...
for dir in "${directories[@]}"; do
    for file in "$dir"/01_qualityTrim/*_subclean.fastq.gz; do
        ...
        python /home/hooimin/lu2024-17-19/RAAV-72/scripts/libraryExt_p007.py "$dir/04_library/$processed_name1" "$dir/04_library/${base_name1}_72_007.fastq.gz"
    done
done
