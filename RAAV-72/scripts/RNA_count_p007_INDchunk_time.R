...
for (chunk_index in seq_along(output_chunks)) {
  ...
  name.out <- paste0("p007_72_S59_S8_L001_R1_001_chunk_", chunk_index)
  ...
  if (length(foundFragments.ranges) > 0) {
    ...
    saveRDS(foundFragments.ranges, file = paste("06_traceBack/04_p007_found/", "found.", name.out, ".rds", sep = ""), compress = TRUE)
  }
