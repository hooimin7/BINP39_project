...
#SBATCH -J Starcode
#SBATCH -o /home/hooimin/lu2024-17-19/RAAV-30/p006_AAV_02/05_starcode/star.out
#SBATCH -e /home/hooimin/lu2024-17-19/RAAV-30/p006_AAV_02/05_starcode/star.err
#SBATCH -D /home/hooimin/lu2024-17-19/RAAV-30/p006_AAV_02/05_starcode
...
## Input Files
in_name_BC_paired="../03_pairfq/barcodes_6_BarLib_paired_reads.fastq.gz" # change input file name
...
reads_BC="../03_pairfq/barcodes_6_BarLib_paired_reads.fastq.gz"
