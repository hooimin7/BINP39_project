...
#SBATCH -J BarExt
#SBATCH -o /home/hooimin/lu2024-17-19/RAAV-30/p006_AAV_02/02_BarExt/extract_6.out
#SBATCH -e /home/hooimin/lu2024-17-19/RAAV-30/p006_AAV_02/02_BarExt/extract_6.err
#SBATCH -D /home/hooimin/lu2024-17-19/RAAV-30/p006_AAV_02/02_BarExt

# write this script to stdout-file 
cat $0

## Input Files
in_name_R1="../01_qualityTrim/AAV23-02_S2_R1_001_subclean.fastq.gz" # change input file name
