...
#SBATCH -J p005RNA_count
#SBATCH -o /home/hooimin/lu2024-17-19/RAAV-30/p005_AAV_01/06_traceBack/02_analysis/RNA.out
#SBATCH -e /home/hooimin/lu2024-17-19/RAAV-30/p005_AAV_01/06_traceBack/02_analysis/RNA.err
#SBATCH -D /home/hooimin/lu2024-17-19/RAAV-30/p005_AAV_01/06_traceBack
...
# sort -t, -k1,1 02_analysis/found.p005_AAV_01.csv > 02_analysis/sorted_found.p005_AAV_01.csv
# awk -F, '!seen[$1]++' 02_analysis/sorted_found.p005_AAV_01.csv > 02_analysis/unique_sorted_found.p005_AAV_01.csv
