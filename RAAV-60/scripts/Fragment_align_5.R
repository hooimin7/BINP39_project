...
write.csv(full.table, file = "02_analysis/fragment_align_5.csv", row.names = FALSE)

DNA_pscAAVlib <- full.table

save(DNA_pscAAVlib, file = "02_analysis/scBC_DNA_pscAAVlib_p005.rda")

# Read the CSV file without the header
fragment_align <- fread("02_analysis/fragment_align_5.csv", header = TRUE)
...
write.csv(sorted_fragment_align, file = "02_analysis/sorted_fragment_align_5.csv", row.names = FALSE)


# Zipping the output table
file_to_zip <- "02_analysis/sorted_fragment_align_5.csv"

# Define the name of the zip file
zip_file <- "02_analysis/sorted_fragment_align_5.zip"

# Zip the file
zip(zip_file, file_to_zip)

# Save the output table as RDA
save(full.table, file = "02_analysis/sorted_fragment_align_5.rda")
