...
saveRDS(foundFragments.ranges, file = "02_analysis/completeLibraryRanges_p007.rds")

# Save the merged and annotated sequences to a csv file
write.csv(foundFragments.ranges, file = "02_analysis/completeLibraryRanges_p007.csv", row.names = FALSE)
