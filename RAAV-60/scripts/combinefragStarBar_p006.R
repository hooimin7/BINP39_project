...
# Reduce barcode
out.name.BC.star <- "../07_starcode/01_data/barcodes_6_reduced.txt"
...
temp.table.multi <- unique(temp.table.multi, by = c("BC"))
...
# write.csv(output.Table, file = "02_analysis/multipleContfragmentsCompleteNoLUT.csv", row.names = FALSE)

# Save the output table as RDA
save(output.Table, file = "02_analysis/multipleContfragmentsCompleteNoLUT.rda")

# Save the output table as RDS
saveRDS(output.Table, file = "02_analysis/multipleContfragmentsCompleteNoLUT.rds")