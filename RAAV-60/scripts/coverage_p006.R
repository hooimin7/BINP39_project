...
load("../../p005/05_bowtie/alignedLibraries.rda")
...
saveRDS(foundFragments.ranges, file = "02_analysis/completeLibraryRanges_p006.rds")

# Save the merged and annotated sequences to a csv file
write.csv(foundFragments.ranges, file = "02_analysis/completeLibraryRanges_p006.csv", row.names = FALSE)
