...
processed_name1 = 'p007a_S4_L001_R1_001_LibExt_p007_6.fastq.gz'
output_file = 'library_007_6.fastq.gz'

with gzip.open(processed_name1, 'rt') as infile, open(output_file, 'w') as outfile:
    while True:
