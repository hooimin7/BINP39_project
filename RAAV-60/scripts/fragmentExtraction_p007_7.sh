...
#SBATCH -J FragBarExt
#SBATCH -o /home/hooimin/lu2024-17-19/RAAV-60/p007/02_fragBarExt/extract_7b.out
#SBATCH -e /home/hooimin/lu2024-17-19/RAAV-60/p007/02_fragBarExt/extract_7b.err
...
## Input Files
in_name_R1="../01_qualityTrim/p007b_S5_L001_R1_001_subclean.fastq.gz" # change input file name

in_name_R2="../01_qualityTrim/p007b_S5_L001_R2_001_subclean.fastq.gz" # change input file name


# Fragment analysis
out_name_R2=$(mktemp -p . "p007R2_frg_XXXXXXXXXX.fastq.gz")
num_cores=$(nproc --all)
...
processed_name2="${base_name2}_fragExt_7.fastq.gz"
mv "$out_name_R2" "$processed_name2"


# Barcode analysis
out_name_R1=$(mktemp -p . "p007R1_bar_XXXXXXXXXX.fastq.gz")
num_cores=$(nproc --all)
...
processed_name1="${base_name1}_barExt_7.fastq.gz"
