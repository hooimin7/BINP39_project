...
#SBATCH -J FragBarExt
#SBATCH -o /home/hooimin/lu2024-17-19/RAAV-60/p006/02_fragBarExt/extract_6.out
#SBATCH -e /home/hooimin/lu2024-17-19/RAAV-60/p006/02_fragBarExt/extract_6.err
#SBATCH -D /home/hooimin/lu2024-17-19/RAAV-60/p006/02_fragBarExt

# write this script to stdout-file 
cat $0

## Input Files
in_name_R1="../01_qualityTrim/p006_S3_L001_R1_001_subclean.fastq.gz" # change input file name

in_name_R2="../01_qualityTrim/p006_S3_L001_R2_001_subclean.fastq.gz" # change input file name
...
processed_name2="${base_name2}_fragExt_6.fastq.gz"
...
in="$in_name_R1" out="$out_name_R1" lliteral="TCTTATCTCGTGGTAC" rliteral="ATAACTTCGTATAATG" 2>&1

base_name1=$(basename "$in_name_R1" _subclean.fastq.gz)
processed_name1="${base_name1}_barExt_6.fastq.gz"
