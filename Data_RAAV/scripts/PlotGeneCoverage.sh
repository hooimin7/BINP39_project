...
#SBATCH -J AllGeneCoveraga
#SBATCH -o /home/hooimin/lu2024-17-19/Data_RAAV/p006_data/04_plot/top25_AAV_lib/plot.out
#SBATCH -e /home/hooimin/lu2024-17-19/Data_RAAV/p006_data/04_plot/top25_AAV_lib/plot.err
...
Rscript ../scripts/PlotAllGenesCoverage_copy2_ind.R
