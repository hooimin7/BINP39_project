...
file1 <- file.path(base_dir, "02_rds", "found.p005_53_42_S15_L001_R1_001.rds")
...
normalize_chunk <- function(chunk_index, file1_data, GENETIC_CODE_ALT, readCounts) {
  ...
  saveRDS(all.samples, file = paste0("03_normalize/42_S15/allSamples_p005_42_chunk", chunk_index, ".RDS"))
  ...
  saveRDS(readCounts, file = paste0("03_normalize/42_S15/readCounts_p005_42_chunk", chunk_index, ".RDS"))
  ...
  saveRDS(final_normalized_data, file = paste0("03_normalize/42_S15/normalized_p005_42_data", chunk_index, ".RDS"))
  ...
  saveRDS(final_normalized_data, file = paste0("03_normalize/42_S15/allSamplesDataTable_p005_53_42_chunk", chunk_index, ".RDS"))
}
...
for (i in 1:num_chunks) {
  file.remove(paste0("03_normalize/42_S15/allSamples_p005_42_chunk", i, ".RDS"))
  file.remove(paste0("03_normalize/42_S15/readCounts_p005_42_chunk", i, ".RDS"))
  file.remove(paste0("03_normalize/42_S15/normalized_p005_42_data", i, ".RDS"))
}