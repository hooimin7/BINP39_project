...
#SBATCH -J VennPlot
#SBATCH -o /home/hooimin/lu2024-17-19/Data_RAAV/p007_data/05_vennplot/Vennplot_test.out
#SBATCH -e /home/hooimin/lu2024-17-19/Data_RAAV/p007_data/05_vennplot/Vennplot_test.err
...
Rscript ../scripts/VennPlot_p007.R
