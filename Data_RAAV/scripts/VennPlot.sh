...
#SBATCH -J VennPlot
#SBATCH -o /home/hooimin/lu2024-17-19/Data_RAAV/p006_data/05_vennplot/Vennplot.out
#SBATCH -e /home/hooimin/lu2024-17-19/Data_RAAV/p006_data/05_vennplot/Vennplot.err
