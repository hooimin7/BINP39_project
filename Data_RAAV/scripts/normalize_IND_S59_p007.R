...
file1 <- file.path(base_dir, "02_rds", "found.p007_72_S59_S8_L001_R1_001.rds")
...
normalize_chunk <- function(chunk_index, file1_data, GENETIC_CODE_ALT) {
  ...
  saveRDS(all.samples, file = paste0("03_normalize/S59_S8/allSamplesDataTable_p007_S59_chunk", chunk_index, ".RDS"))
...
chunk_files <- list.files("03_normalize/S59_S8", pattern = "allSamplesDataTable_p007_S59_chunk.*\\.RDS", full.names = TRUE)
...
saveRDS(final_normalized_data, file = "03_normalize/S59_S8/allSamplesDataTable_final_p007_S59.RDS")

# Load the final combined normalized data
final_normalized_data <- readRDS("03_normalize/S59_S8/allSamplesDataTable_final_p007_S59.RDS")
...
saveRDS(final_normalized_data, file = "03_normalize/S59_S8/allSamplesDataTable_final_normalized_p007_72_S59.RDS")